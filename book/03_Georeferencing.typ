...
*Важно:* *Координатная система отсчета:*
...
#figure(image("../images/coord_transform.png", width: 60%))
...
#figure(image("../images/mollweide_1.png", width: 100%))

#figure(image("../images/mollweide_2.png", width: 100%))

== spatialreference.org

Удобный ресурс для поиска описаний координатных систем отсчета

#figure(image("../images/image-1882413297.png", width: 80%))

== proj.org

Сайт библиотеки PROJ имеет описания проекций

#figure(image("../images/image-69855955.png", width: 80%))
...
#figure(image("../images/image-634598051.png", width: 80%))
...
*Совет:* *Когда нужна координатная привязка?:*
...
#figure(image("../images/control_pts.svg", width: 100%))
...
*Совет:* *Уточнение:*
    Векторизации в режме преобразования обычно подвергаются растровые данные.
    :::
...
#figure(image("../images/image-1928425450.png", width: 80%))
...
#figure(image("../images/image-11396456.png", width: 80%))

#figure(image("../images/image-1313555464.png", width: 80%))
...
#figure(image("../images/image-587177276.png", width: 80%))

#figure(image("../images/image-635340267.png", width: 80%))
...
#figure(image("../images/field_map.png", width: 80%))
...
#figure(image("../images/addr_source.png", width: 90%))

**Результаты геокодирования**

#figure(image("../images/addr_res.png", width: 90%))
...
#figure(image("../images/vectorize.svg", width: 65%))
...
#figure(image("../images/image-91314596.png", width: 80%))

    [yurtseven2019]

**Векторизация** может осуществляться в автоматическом, автоматизированном и ручном режиме.

#figure(image("../images/vec_manual_crop.gif", width: 80%))
...
*Совет:* *Пример:*
Классический пример цифрования --- получение растра топографической карты по результатам сканирования.

*Предупреждение:* *Соотношение с векторизацией:*
