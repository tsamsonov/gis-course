...
Для гидрологического анализа играют очень важную роль процедуры предварительной подготовки ЦМР, такие как *устранение ошибочных замкнутых понижений*.
:::
...
%%| fig-width: 15
flowchart TB
  A(ЦМР) --> B(Предварительная подготовка)
