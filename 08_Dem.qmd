...
::: {.column width="45%"}
![Цифровая модель высот](images/d8_process0.svg){width="100%"}
:::
:::::
...
::: {.column width="45%"}
![Разности высот](images/d8_process1.svg){width="100%"}
:::
:::::
...
::: {.column width="45%"}
![Скорректированные разности высот](images/d8_process2.svg){width="100%"}
:::
:::::
...
::: {.column width="45%"}
![Ячейка с минимальной разностью](images/d8_process3.svg){width="100%"}
:::
:::::
...
:::: {.column width="45%"}
![Код направления D8](images/d8_final.svg){width="100%"}
...
::: {.column width="50%"}
![Пример растра направлений стока **D8**](images/d8_ex.svg){width="100%"}
:::
:::::
...
%%| fig-width: 15
flowchart TB
  A(ЦМР) --> B(Устранение ошибочных понижений)
  B --> C(Направления стока)
  C --> D(Аккумуляция стока)
  C --> E(Потенциальные водотоки)
  D --> E
  C --> F(Бассейны)
  D -.-> F
```
